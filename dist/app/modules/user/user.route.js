...
router.post('/user/create-facality', (0, auth_1.default)(user_constance_1.User_Role.admin, user_constance_1.User_Role.superAdmin), (0, validatonJoi_1.default)(joi_validation_1.createTeacherValidation), user_controller_1.UsersController.createFacality);
router.post('/user/create-admin', (0, auth_1.default)(user_constance_1.User_Role.admin, user_constance_1.User_Role.superAdmin), (0, validatonJoi_1.default)(admin_validation_1.createAdminValidationSchema), user_controller_1.UsersController.createAdmin);
