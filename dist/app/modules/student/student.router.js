...
router.get('/getStudent', (0, auth_1.default)(user_constance_1.User_Role.faculity, user_constance_1.User_Role.admin), student_controller_1.studentController.getAllStudents);
router.get('/singleStudent/:_id', (0, auth_1.default)(user_constance_1.User_Role.admin, user_constance_1.User_Role.faculity), student_controller_1.studentController.getSingleStudent);
